...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/opendash/opendash/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for opendash/opendash...\n")
...
console.log("Fetching npm all-time downloads for opendash-ai...\n")
const npmDownloads = await fetchNpmDownloads("opendash-ai")
