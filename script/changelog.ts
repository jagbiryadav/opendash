...
Generates UPCOMING_CHANGELOG.md by running the opendash changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for opendash run (default: low)
      --quiet            Suppress opendash command output unless it fails
