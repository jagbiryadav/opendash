# Xiaomi OpenDash Use Restrictions

## Use Restrictions

You are solely responsible for your use of Xiaomi OpenDash and any outputs, actions, or consequences arising therefrom, and you agree not to use Xiaomi OpenDash or any derivatives thereof:
...
- To engage in or facilitate malicious cyber activities, including but not limited to malware, ransomware, phishing, credential theft, or unauthorized access, or any activity intended to compromise or unlawfully control computer systems, networks, or encryption systems;
...
- To use Xiaomi OpenDash in a manner that autonomously executes high-risk actions without appropriate human oversight or authorization.
