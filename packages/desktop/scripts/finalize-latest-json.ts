...
const releaseId = process.env.OPENDASH_RELEASE
if (!releaseId) throw new Error("OPENDASH_RELEASE is required")

const version = process.env.OPENDASH_VERSION
if (!version) throw new Error("OPENDASH_VERSION is required")
...
const macxTarGz = "opendash-desktop-mac-x64.app.tar.gz"
const macaTarGz = "opendash-desktop-mac-arm64.app.tar.gz"
