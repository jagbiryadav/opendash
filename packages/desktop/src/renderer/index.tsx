...
import "./styles.css"
import { useTheme } from "@opendash-ai/ui/theme"
...
const deepLinkEvent = "opendash:deep-link"
  ...
  return {
    ...
    notify: async (title, description, href) => {
      ...
      const notification = new Notification(title, {
        body: description ?? "",
        icon: "https://opendashai.netlify.app/favicon-96x96-v3.png",
      })
...
render(() => {
  ...
  const loadLocale = async () => {
    const current = await platform.storage?.("opendash.global.dat").getItem("language")
