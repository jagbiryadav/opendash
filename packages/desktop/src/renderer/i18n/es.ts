export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de OpenDash",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de OpenDash. ¿Quieres instalarla y reiniciar?",
