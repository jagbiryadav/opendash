...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opendash.git")).toEqual({ owner: "sst", repo: "opendash" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/opendash")).toEqual({ owner: "sst", repo: "opendash" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opendash.git")).toEqual({ owner: "sst", repo: "opendash" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/opendash")).toEqual({ owner: "sst", repo: "opendash" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opendash.git")).toEqual({ owner: "sst", repo: "opendash" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/opendash")).toEqual({ owner: "sst", repo: "opendash" })
})
