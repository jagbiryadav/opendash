...
process.env.OPENDASH_DISABLE_COMPOSE_SKILLS = "true"
process.env.OPENDASH_DISABLE_BUILTIN_SKILLS = "true"
...
describe("skill", () => {
  it.live("discovers skills from .opendash/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".opendash", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".opendash", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".opendash", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .opendash/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".opendash", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".opendash", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".opendash", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".opendash", "skill", "agent-skill", "SKILL.md"),
                `---
name: opendash-skill
description: A skill in the .opendash/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".opendash", "skills", "agent-skill", "SKILL.md"),
                `---
name: opendash-skill
description: A skill in the .opendash/skills directory.
---
