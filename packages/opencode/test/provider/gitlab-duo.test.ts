...
// import { GitLabWorkflowLanguageModel } from "opencode-gitlab-auth"
...
//     await using tmp = await tmpdir({
//       init: async (dir) => {
//         await Bun.write(path.join(dir, "opendash.json"), JSON.stringify({ $schema: "https://opendashai.netlify.app/config.json" }))
//       },
//     })
//     await Instance.provide({
//       directory: tmp.path,
...
//           family: "",
//           api: { id: "duo-workflow-sonnet-4-6", url: "https://gitlab.com", npm: "opencode-gitlab-auth" },
//           status: "active",
//           headers: {},
