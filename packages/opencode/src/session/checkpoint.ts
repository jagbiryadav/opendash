...
export class Service extends Context.Service<Service, Interface>()("@opendash/SessionCheckpoint") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const tryStartCheckpointWriter: (
      ...
      // and same-message.id thinking blocks aren't split. OpenDash's ToolPart
