import type { NamedError } from "@opendash-ai/shared/util/error"
...
export const GO_UPSELL_MESSAGE = "Free usage exceeded. Configure a paid provider in /providers to continue."
