...
export function createTextNgramMonitor() {
  return new TextNgramMonitor(
    Flag.OPENDASH_TEXT_NGRAM_N,
    Flag.OPENDASH_TEXT_REPEAT_THRESHOLD,
    Flag.OPENDASH_TEXT_WINDOW_TOKENS,
  )
}
...
REPETITION DETECTED: Your recent output contains repeated phrases (sliding n-gram match within your last ${Flag.OPENDASH_TEXT_WINDOW_TOKENS} tokens).
