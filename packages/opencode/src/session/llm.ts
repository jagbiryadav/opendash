...
// GitLabWorkflowLanguageModel not available in current package version
 ...
 *   (configured per-provider via `chunkTimeout` in opendash.json). This
...
export class Service extends Context.Service<Service, Interface>()("@opendash/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // GitLabWorkflowLanguageModel not available - workflow tool wiring disabled
      if (false) {
