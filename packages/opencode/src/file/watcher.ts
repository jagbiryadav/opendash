...
export class Service extends Context.Service<Service, Interface>()("@opendash/FileWatcher") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("FileWatcher.state")(
        function* () {
          if (yield* Flag.OPENDASH_EXPERIMENTAL_DISABLE_FILEWATCHER) return
          ...
          if (yield* Flag.OPENDASH_EXPERIMENTAL_FILEWATCHER) {
