...
import { sanitizedProcessEnv } from "@/util/opendash-process"
...
export class Service extends Context.Service<Service, Interface>()("@opendash/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".opendash")) continue
