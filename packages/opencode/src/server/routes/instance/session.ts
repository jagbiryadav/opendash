...
function promptHeartbeatIntervalMs() {
  return Number(process.env["OPENDASH_PROMPT_HEARTBEAT_INTERVAL_MS"]) || 10_000
}
  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all OpenDash sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific OpenDash session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new OpenDash session for interacting with AI assistants and managing conversations.",
