...
const EVENT_QUEUE_CAPACITY = Number(process.env["OPENDASH_EVENT_QUEUE_CAPACITY"]) || 10_000
...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the OpenDash server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the OpenDash system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global OpenDash configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global OpenDash configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all OpenDash instances, releasing all resources.",
    ...
    .post(
      "/upgrade",
      describeRoute({
        summary: "Upgrade opendash",
        description: "Upgrade opendash to the specified version or latest if not specified.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description:
          "Detect availability and session counts of external AI tool session stores (Claude Code, Codex, opendash). Read-only.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          "Import sessions from external AI tools (Claude Code, Codex, opendash) into opendash. Idempotent; pass force to re-sync. Per-source failures are not thrown as HTTP errors — they are collected into the corresponding stats.errors[] while other sources continue.",
      ...
      validator(
        "json",
        z.object({
          sources: z.array(z.enum(["cc", "codex", "opendash"])).optional(),
