...
export class Service extends Context.Service<Service, Interface>()("@opendash/AccountRepo") {}
...
export const layer: Layer.Layer<Service> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const persistToken: Interface["persistToken"] = Effect.fn("AccountRepo.persistToken")((input) =>
      query((db) =>
        db
          .update(AccountTable)
          .set({
    ...
    const persistAccount: Interface["persistAccount"] = Effect.fn("AccountRepo.persistAccount")((input) =>
      tx((db) => {
