...
const DEFAULT_BASE_URL = "https://opendash.ai/zen/v1"

export const QUOTA_EXCEEDED =
  "Web search quota exhausted (free tier limit reached). Top up or manage your plan at https://opendash.ai, or use `webfetch` with a relevant URL instead."
