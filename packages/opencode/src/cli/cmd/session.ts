...
function pagerCmd(): string[] {
  ...
  if (Flag.OPENDASH_GIT_BASH_PATH) {
    const less = path.join(Flag.OPENDASH_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into opendash",
  builder: (yargs: Argv) =>
    yargs.option("force", {
