...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 OpenDash 即表示你同意我们的",
  ...
  "tui.tips.config_files":
    "创建 {highlight}opendash.json{/highlight} 用于服务端配置，{highlight}tui.json{/highlight} 用于 TUI 配置",
  "tui.tips.global_config": "把 TUI 配置放在 {highlight}~/.config/opendash/tui.json{/highlight} 作为全局配置",
  ...
  "tui.tips.mcp_oauth": "OpenDash 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.opendash/command/{/highlight} 添加 {highlight}.md{/highlight} 文件以定义可复用自定义提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.opendash/agent/{/highlight} 添加 {highlight}.md{/highlight} 文件来创建专用 AI 角色",
  ...
  "tui.tips.formatter": "OpenDash 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "OpenDash 使用 LSP 服务器进行智能代码分析",
  "tui.tips.custom_tool":
    "在 {highlight}.opendash/tools/{/highlight} 创建 {highlight}.ts{/highlight} 文件定义新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定义可以调用 Python、Go 等脚本",
  "tui.tips.plugins":
    "在 {highlight}.opendash/plugin/{/highlight} 添加 {highlight}.ts{/highlight} 文件挂接事件钩子",
  "tui.tips.plugin_notify": "用插件在会话完成时发送系统通知",
  "tui.tips.plugin_protect": "写一个插件阻止 OpenDash 读取敏感文件",
  "tui.tips.run": "用 {highlight}oa run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}opendash --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}oa run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}oa serve{/highlight} 以无头模式提供 OpenDash API",
  "tui.tips.attach_server": "用 {highlight}oa run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}oa upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}opendash auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}opendash agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/opendash{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}opendash github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.opendash/themes/{/highlight} 目录下创建 JSON 主题文件",
  ...
  "tui.tips.debug_config": "运行 {highlight}opendash debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.docker": "运行 {highlight}docker run -it --rm ghcr.io/opendash/opendash{/highlight} 使用容器化版本",
  ...
  "tui.command.opendash.status.title": "查看状态",
  ...
  "tui.model.mimo_auto.name": "OpenDash（MiMo-V2.5 限免中）",
  ...
  "tui.toast.update_available.success": "已更新到 OpenDash v{{version}}，请重启应用。",
  ...
  "tui.voice.error.no_auth": "请用 /connect 连接服务商，或在配置中设置 voice.asr_api_key + voice.asr_model（支持 openai、groq、deepgram、sarvam、xiaomi）",
  ...
  "tui.dialog.login.title": "连接服务商",
  "tui.dialog.login.xiaomi": "小米",
  "tui.dialog.login.xiaomi.desc": "",
  "tui.dialog.login.opendash_zen": "OpenDash Zen",
  "tui.dialog.login.opendash_zen.desc": "最佳编程模型，最低价格，单一 API 密钥",
  "tui.dialog.login.opendash_zen.key_placeholder": "输入 API 密钥",
  "tui.dialog.login.opendash_zen.description": "OpenDash Zen 以单一 API 密钥为您提供所有最佳编程模型的最低价格访问。请前往",
  "tui.dialog.login.opendash_zen.success": "OpenDash Zen 已连接",
  "tui.dialog.login.mimo_free": "OpenDash (free)",
  "tui.dialog.login.mimo_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.mimo_free.success": "OpenDash (free) 已就绪 - 默认模型设为 mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "OpenDash (free) 通道未加载",
  ...
  "cli.providers.mimo_free.verifying": "正在验证 OpenDash (free) 通道...",
  "cli.providers.mimo_free.ready": "OpenDash (free) 通道已就绪",
  "cli.providers.mimo_free.failed": "OpenDash (free) 自检失败",
  "cli.providers.mimo_free.default_set": "默认模型已切换为 mimo/mimo-auto（1M 上下文，免费）",
  "cli.providers.mimo_free.usage_hint": "无需登录，直接 oa run 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",
