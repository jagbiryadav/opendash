...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar OpenDash, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}opendash.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/opendash/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "OpenDash gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.opendash/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.opendash/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "OpenDash formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "OpenDash usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.opendash/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.opendash/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a OpenDash leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}oa run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}opendash --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}oa run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}oa serve{/highlight} para acceso headless a la API de OpenDash",
  "tui.tips.attach_server":
    "Usa {highlight}oa run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}oa upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}opendash auth list{/highlight} para ver todos los proveedores configurados",
  "tui.tips.agent_create":
    "Ejecuta {highlight}opendash agent create{/highlight} para crear un agente con asistente guiado",
  "tui.tips.github_trigger":
    "Usa {highlight}/opendash{/highlight} en issues/PR de GitHub para disparar acciones de IA",
  "tui.tips.github_install":
    "Ejecuta {highlight}opendash github install{/highlight} para configurar el workflow de GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.opendash/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}opendash debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Ejecuta {highlight}docker run -it --rm ghcr.io/opendash/opendash{/highlight} para uso en contenedor",
  "tui.tips.zen":
  ...
  "tui.command.opendash.status.title": "Ver estado",
  ...
  "tui.model.mimo_auto.name": "OpenDash (MiMo-V2.5, gratis por tiempo limitado)",
  ...
  "tui.toast.update_available.success": "Se actualizó a OpenDash v{{version}}. Por favor reinicie la aplicación.",
