...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant OpenDash, vous acceptez nos ",
  ...
  "tui.tips.config_files":
    "Créez {highlight}opendash.json{/highlight} pour la configuration serveur et {highlight}tui.json{/highlight} pour le TUI",
  "tui.tips.global_config":
    "Placez les paramètres TUI dans {highlight}~/.config/opendash/tui.json{/highlight} comme configuration globale",
  ...
  "tui.tips.mcp_oauth":
    "OpenDash gère automatiquement OAuth pour les serveurs MCP distants nécessitant une authentification",
  "tui.tips.custom_command":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.opendash/command/{/highlight} pour définir des invites personnalisées réutilisables",
  ...
  "tui.tips.custom_agent":
    "Ajoutez des fichiers {highlight}.md{/highlight} dans {highlight}.opendash/agent/{/highlight} pour des personas IA spécialisés",
  ...
  "tui.tips.formatter": "OpenDash formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.tips.lsp": "OpenDash utilise des serveurs LSP pour une analyse de code intelligente",
  "tui.tips.custom_tool":
    "Créez des fichiers {highlight}.ts{/highlight} dans {highlight}.opendash/tools/{/highlight} pour définir de nouveaux outils LLM",
  "tui.tips.tool_scripts": "Les définitions d'outils peuvent invoquer des scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Ajoutez des fichiers {highlight}.ts{/highlight} dans {highlight}.opendash/plugin/{/highlight} pour des hooks d'événements",
  ...
  "tui.tips.plugin_protect":
    "Créez un plugin pour empêcher OpenDash de lire des fichiers sensibles",
  "tui.tips.run": "Utilisez {highlight}oa run{/highlight} pour des scripts non interactifs",
  "tui.tips.continue": "Utilisez {highlight}opendash --continue{/highlight} pour reprendre la dernière session",
  "tui.tips.attach_cli":
    "Utilisez {highlight}oa run -f file.ts{/highlight} pour joindre des fichiers via la CLI",
  "tui.tips.format_json":
    "Utilisez {highlight}--format json{/highlight} pour une sortie lisible par machine dans les scripts",
  "tui.tips.serve": "Exécutez {highlight}oa serve{/highlight} pour exposer l'API OpenDash en mode headless",
  "tui.tips.attach_server":
    "Utilisez {highlight}oa run --attach{/highlight} pour vous connecter à un serveur en cours",
  "tui.tips.upgrade": "Exécutez {highlight}oa upgrade{/highlight} pour passer à la dernière version",
  "tui.tips.auth_list":
    "Exécutez {highlight}opendash auth list{/highlight} pour voir tous les fournisseurs configurés",
  "tui.tips.agent_create":
    "Exécutez {highlight}opendash agent create{/highlight} pour créer un agent en mode guidé",
  "tui.tips.github_trigger":
    "Utilisez {highlight}/opendash{/highlight} dans les issues/PR GitHub pour déclencher des actions IA",
  "tui.tips.github_install":
    "Exécutez {highlight}opendash github install{/highlight} pour configurer le workflow GitHub",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Créez des fichiers de thème JSON dans le dossier {highlight}.opendash/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Exécutez {highlight}opendash debug config{/highlight} pour diagnostiquer la configuration",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Exécutez {highlight}docker run -it --rm ghcr.io/opendash/opendash{/highlight} pour une utilisation conteneurisée",
  "tui.tips.zen":
  ...
  "tui.command.opendash.status.title": "Voir l'état",
  ...
  "tui.model.mimo_auto.name": "OpenDash (MiMo-V2.5, gratuit pour une durée limitée)",
  ...
  "tui.toast.update_available.success": "Mis à jour vers OpenDash v{{version}}. Veuillez redémarrer l'application.",
  ...
  // OpenDash (free) — TUI login dialog
  "tui.dialog.login.mimo_free": "OpenDash (free)",
  "tui.dialog.login.mimo_free.desc": "Canal anonyme gratuit — aucune connexion requise",
  "tui.dialog.login.mimo_free.success": "OpenDash (free) est prêt — modèle par défaut défini sur mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Fournisseur OpenDash (free) non chargé",
  ...
  "cli.providers.mimo_free.verifying": "Vérification du canal OpenDash (free)...",
  "cli.providers.mimo_free.ready": "Canal OpenDash (free) prêt",
  "cli.providers.mimo_free.failed": "Échec de la vérification de OpenDash (free)",
  ...
  "cli.providers.mimo_free.usage_hint":
    "Aucune connexion requise — exécutez simplement opendash. Pour les modèles payants/premium, choisissez plutôt la connexion navigateur MiMo.",
