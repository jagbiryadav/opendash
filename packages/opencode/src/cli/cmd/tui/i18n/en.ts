export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using OpenDash, you agree to our ",
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation",
  ...
  "tui.tips.config_files":
    "Create {highlight}opendash.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/opendash/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "OpenDash auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.opendash/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.opendash/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "OpenDash auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "OpenDash uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.opendash/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.opendash/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent OpenDash from reading sensitive files",
  "tui.tips.run": "Use {highlight}oa run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}opendash --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}oa run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}oa serve{/highlight} for headless API access to OpenDash",
  "tui.tips.attach_server": "Use {highlight}oa run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}oa upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}opendash auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}opendash agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opendash{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}opendash github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.opendash/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}opendash debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/opendash/opendash{/highlight} for containerized use",
  ...
  "tui.command.opendash.status.title": "View status",
  ...
  "tui.model.mimo_auto.name": "OpenDash (MiMo-V2.5, limited-time free)",
  ...
  "tui.toast.update_available.success": "Successfully updated to OpenDash v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to add a provider, or set voice.asr_api_key + voice.asr_model in config (supports openai, groq, deepgram, sarvam, xiaomi)",
  ...
  "tui.dialog.login.title": "Connect a provider",
  "tui.dialog.login.xiaomi": "Xiaomi",
  "tui.dialog.login.xiaomi.desc": "",
  "tui.dialog.login.opendash_zen": "OpenDash Zen",
  "tui.dialog.login.opendash_zen.desc": "Best coding models, cheapest prices, single API key",
  "tui.dialog.login.opendash_zen.key_placeholder": "Enter API key",
  "tui.dialog.login.opendash_zen.description": "OpenDash Zen gives you access to all the best coding models at the cheapest prices with a single API key. Go to",
  "tui.dialog.login.opendash_zen.success": "OpenDash Zen connected",
  "tui.dialog.login.mimo_free": "OpenDash (free)",
  "tui.dialog.login.mimo_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.mimo_free.success": "OpenDash (free) is ready — default model set to mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "OpenDash (free) provider not loaded",
  ...
  "cli.providers.mimo_free.verifying": "Verifying OpenDash (free) channel...",
  "cli.providers.mimo_free.ready": "OpenDash (free) channel ready",
  "cli.providers.mimo_free.failed": "OpenDash (free) verification failed",
  "cli.providers.mimo_free.default_set": "Default model set to mimo/mimo-auto (1M context, free)",
  "cli.providers.mimo_free.usage_hint": "No login required — just run opendash. For paid/premium models, choose MiMo browser login instead.",
