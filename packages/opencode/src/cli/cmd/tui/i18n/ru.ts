...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Используя OpenDash, вы соглашаетесь с нашими ",
  ...
  "tui.tips.config_files":
    "Создайте {highlight}opendash.json{/highlight} для серверных настроек и {highlight}tui.json{/highlight} для настроек TUI",
  "tui.tips.global_config":
    "Поместите настройки TUI в {highlight}~/.config/opendash/tui.json{/highlight} как глобальные",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "OpenDash автоматически обрабатывает OAuth для удалённых MCP-серверов с авторизацией",
  "tui.tips.custom_command":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.opendash/command/{/highlight} для повторно используемых пользовательских команд",
  ...
  "tui.tips.custom_agent":
    "Добавляйте файлы {highlight}.md{/highlight} в {highlight}.opendash/agent/{/highlight} для специализированных AI-персон",
  ...
  "tui.tips.formatter":
    "OpenDash автоматически форматирует файлы с помощью prettier, gofmt, ruff и других инструментов",
  ...
  "tui.tips.lsp": "OpenDash использует LSP-серверы для интеллектуального анализа кода",
  "tui.tips.custom_tool":
    "Создавайте файлы {highlight}.ts{/highlight} в {highlight}.opendash/tools/{/highlight}, чтобы определить новые LLM-инструменты",
  "tui.tips.tool_scripts":
    "Определения инструментов могут вызывать скрипты на Python, Go и других языках",
  "tui.tips.plugins":
    "Добавляйте файлы {highlight}.ts{/highlight} в {highlight}.opendash/plugin/{/highlight} для подключения хуков событий",
  ...
  "tui.tips.plugin_protect":
    "Создайте плагин, который запретит OpenDash читать чувствительные файлы",
  "tui.tips.run":
    "Используйте {highlight}oa run{/highlight} для неинтерактивных скриптов",
  "tui.tips.continue":
    "Используйте {highlight}opendash --continue{/highlight}, чтобы продолжить последнюю сессию",
  "tui.tips.attach_cli":
    "Используйте {highlight}oa run -f file.ts{/highlight}, чтобы прикрепить файлы из командной строки",
  "tui.tips.format_json":
    "Используйте {highlight}--format json{/highlight} для машинно-читаемого вывода в скриптах",
  "tui.tips.serve":
    "Запустите {highlight}oa serve{/highlight} для headless-доступа к API OpenDash",
  "tui.tips.attach_server":
    "Используйте {highlight}oa run --attach{/highlight}, чтобы подключиться к запущенному серверу",
  "tui.tips.upgrade":
    "Выполните {highlight}oa upgrade{/highlight}, чтобы обновиться до последней версии",
  "tui.tips.auth_list":
    "Выполните {highlight}opendash auth list{/highlight}, чтобы увидеть всех настроенных провайдеров",
  "tui.tips.agent_create":
    "Выполните {highlight}opendash agent create{/highlight}, чтобы создать агента в пошаговом режиме",
  "tui.tips.github_trigger":
    "Используйте {highlight}/opendash{/highlight} в issue/PR на GitHub, чтобы запускать AI-действия",
  "tui.tips.github_install":
    "Выполните {highlight}opendash github install{/highlight}, чтобы настроить GitHub-workflow",
  "tui.tips.github_oc":
  ...
  "tui.tips.theme_files":
    "Создавайте JSON-файлы тем в каталоге {highlight}.opendash/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Выполните {highlight}opendash debug config{/highlight}, чтобы диагностировать проблемы конфигурации",
  "tui.tips.print_logs":
  ...
  "tui.tips.docker":
    "Выполните {highlight}docker run -it --rm ghcr.io/opendash/opendash{/highlight} для контейнерного запуска",
  "tui.tips.zen":
  ...
  "tui.command.opendash.status.title": "Посмотреть статус",
  ...
  "tui.model.mimo_auto.name": "OpenDash (MiMo-V2.5, временно бесплатно)",
  ...
  "tui.toast.update_available.success": "Обновлено до OpenDash v{{version}}. Пожалуйста, перезапустите приложение.",
  ...
  "tui.dialog.login.mimo_free.success": "OpenDash (free) готов — модель по умолчанию: mimo/mimo-auto",
  "tui.dialog.login.mimo_free.unavailable": "Провайдер OpenDash (free) не загружен",
  ...
  "cli.providers.mimo_free.verifying": "Проверка канала OpenDash (free)...",
  "cli.providers.mimo_free.ready": "Канал OpenDash (free) готов",
  "cli.providers.mimo_free.failed": "Не удалось проверить OpenDash (free)",
  ...
  "cli.providers.mimo_free.usage_hint":
    "Вход не требуется — просто запустите opendash. Для платных/премиум-моделей выберите вход через браузер MiMo.",
