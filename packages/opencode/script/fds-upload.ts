...
//   MIMO_FDS_BUCKET / MIMO_FDS_PREFIX    object layout (default opendash/opendash)
//
...
export const FDS_BUCKET = process.env.MIMO_FDS_BUCKET || "opendash"
export const FDS_PREFIX = process.env.MIMO_FDS_PREFIX || "opendash"
...
// Full object name under the bucket, e.g. "opendash/releases/latest".
