---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala opendash.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

opendash zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie opendash uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI opendash, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do opendash. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij opendash. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `opendash.json`, który konfiguruje zachowanie serwera/runtime.
