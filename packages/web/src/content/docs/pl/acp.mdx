---
title: ACP
description: Używanie OpenDash z protokołem Agent Client Protocol (ACP).
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash obsługuje [Agent Client Protocol](https://agentclientprotocol.com) (ACP), który umożliwia korzystanie z OpenDash bezpośrednio w edytorach i środowiskach IDE.
...
Aby używać OpenDash przez ACP, skonfiguruj swój edytor tak, aby uruchamiał polecenie `opendash acp`.

Uruchamia to OpenDash jako podproces zgodny z ACP, który komunikuje się z edytorem za pomocą JSON-RPC przez stdio.
...
Następnie wybierz „OpenDash” w selektorze agentów AI Chat.
...
Aby używać OpenDash jako agenta ACP w [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodaj następującą konfigurację do Neovim:
...
Ta konfiguracja sprawia, że CodeCompanion używa OpenDash jako agenta ACP do czatu.
...
OpenDash działa przez ACP tak samo, jak w terminalu. Obsługiwane są wszystkie główne funkcje:
...
- Serwery MCP zdefiniowane w konfiguracji OpenDash
