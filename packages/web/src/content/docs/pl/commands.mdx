...
Utwórz `.opendash/commands/test.md`:
...
Możesz zdefiniować polecenia w `opendash.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji opendash:
...
- Globalnie: `~/.config/opendash/commands/`
- Na projekt: `.opendash/commands/`
...
opendash zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
