---
title: TUI
description: Korištenje korisničkog interfejsa OpenDash terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenDash pokreće TUI za trenutni direktorij.
...
Kada koristite OpenDash TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenDash. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenDash. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `opendash.json`, koji konfiguriše ponašanje servera/izvršavanja.
