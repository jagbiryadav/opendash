...
Kreiraj `.opendash/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenDash konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenDash [config](/docs/config):
...
- Globalno: `~/.config/opendash/commands/`
- Po projektu: `.opendash/commands/`
...
OpenDash uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
