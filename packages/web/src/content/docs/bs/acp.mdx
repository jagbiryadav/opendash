---
title: ACP podrška
description: Koristite OpenDash u bilo kojem uređivaču kompatibilnom sa ACP.
---

OpenDash podržava [Agent Client Protocol](https://agentclientprotocol.com) (ACP), što vam omogućava da ga koristite direktno u kompatibilnim uređivačima i IDE-ovima.
...
Da biste koristili OpenDash putem ACP-a, konfigurirajte svoj uređivač da pokrene naredbu `opendash acp`.

Naredba pokreće OpenDash kao ACP-kompatibilan podproces koji komunicira sa vašim uređivačem preko JSON-RPC-a kroz stdio.
...
Da biste ga otvorili, koristite novog "OpenDash" agenta u AI Chat agent selektoru.
...
Da koristite OpenDash kao ACP agenta u [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), dodajte sljedeće u svoju Neovim konfiguraciju:
...
Ova konfiguracija postavlja CodeCompanion da koristi OpenDash kao ACP chat agenta.
...
OpenDash radi isto kroz ACP kao i u terminalu. Podržane su sve funkcije:
...
- MCP serveri konfigurisani u vašoj OpenDash konfiguraciji
