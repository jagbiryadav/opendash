---
title: Zen
description: Lista curata di modelli fornita da OpenDash.
---
...
OpenDash Zen è un elenco di modelli testati e verificati forniti dal team di OpenDash.

:::note
OpenDash Zen è attualmente in beta.
:::

Zen funziona come qualsiasi altro provider in OpenDash. Accedi a OpenDash Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenDash.
:::
...
OpenDash Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

OpenDash Zen funziona come qualsiasi altro provider in OpenDash.

1. Accedi a **<a href={console}>OpenDash Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenDash Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenDash
usa il formato `opendash/<model-id>`. Per esempio, per GPT 5.3 Codex, useresti
`opendash/gpt-5.3-codex` nella tua config.
...
- MiniMax M2.5 Free è disponibile su OpenDash per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Super Free è disponibile su OpenDash per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su OpenDash per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenDash Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con OpenDash.
