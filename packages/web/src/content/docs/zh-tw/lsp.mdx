---
title: LSP 伺服器
description: OpenDash 與您的 LSP 伺服器整合。
---

OpenDash 與您的語言伺服器協定（LSP）整合，協助 LLM 與您的程式碼庫進行互動。它利用診斷資訊向 LLM 提供回饋。

---

## 內建支援

OpenDash 內建了多種適用於主流語言的 LSP 伺服器：
...
您可以透過 OpenDash 設定檔中的 `lsp` 部分來自訂 LSP 伺服器。
