---
title: TUI
description: Usando a interface de usuário de terminal opendash.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O opendash fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar opendash inicia o TUI para o diretório atual.
...
Ao usar o TUI do opendash, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao opendash. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do opendash. _Aliases_: `/quit`, `/q`
...
Isso é separado do `opendash.json`, que configura o comportamento do servidor/runtime.
