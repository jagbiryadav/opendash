---
title: TUI
description: Bruke opendash-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenDash starter TUI for gjeldende katalog.
...
Når du bruker OpenDash TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenDash. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenDash. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `opendash.json`, som konfigurerer server-/kjøretidsoppførsel.
