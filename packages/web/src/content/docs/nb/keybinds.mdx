...
OpenDash har en liste over tastebindinger som du kan tilpasse gjennom `tui.json`.
...
OpenDash bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Du kan deaktivere en tastebinding ved å legge til tasten til `tui.json` med en verdi på "none".
...
Prompt-feltet for OpenDash-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `opendash.json`.
