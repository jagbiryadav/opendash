---
title: LSP-servere
description: opendash integreres med LSP-serverne dine.
---

OpenDash integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

OpenDash kommer med flere innebygde LSP-servere for populære språk:
...
Når opendash åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i OpenDash-konfigurasjonen.
