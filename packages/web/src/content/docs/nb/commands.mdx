...
Opprett `.opendash/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenDash-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenDash [config](/docs/config):
...
- Per prosjekt: `.opendash/commands/`
...
OpenDash inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
