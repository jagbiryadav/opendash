---
title: خوادم LSP
description: يتكامل OpenDash مع خوادم LSP لديك.
---

يتكامل OpenDash مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي OpenDash مع عدة خوادم LSP مدمجة للغات الشائعة:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات opendash.
