...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في opendash.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في opendash مثل `read` و`write` و`bash`.
...
- محليا بوضعها في مجلد `.opendash/tools/` داخل مشروعك.
- أو عالميا بوضعها في `~/.config/opendash/tools/`.
