---
title: TUI
description: Utilisation de l’interface utilisateur du terminal OpenDash.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de OpenDash démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le OpenDash TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à OpenDash. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Ceci est séparé de `opendash.json`, qui configure le comportement du serveur/d'exécution.
