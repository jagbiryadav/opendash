---
title: TUI
description: Usando la interfaz de usuario del terminal OpenDash.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar OpenDash se inicia TUI para el directorio actual.
...
Cuando utilice OpenDash TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a OpenDash. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de OpenDash. _Alias_: `/quit`, `/q`
...
Esto es independiente de `opendash.json`, que configura el comportamiento del servidor/tiempo de ejecución.
