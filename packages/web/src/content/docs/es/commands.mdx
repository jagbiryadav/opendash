...
Crear `.opendash/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenDash o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenDash [config](/docs/config):
...
- Por proyecto: `.opendash/commands/`
...
opendash incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
