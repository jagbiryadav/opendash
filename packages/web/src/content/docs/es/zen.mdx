---
title: Zen
description: Lista seleccionada de modelos proporcionada por OpenDash.
---
...
OpenDash Zen es una lista de modelos probados y verificados proporcionada por el equipo de OpenDash.

:::note
OpenDash Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en OpenDash. Inicias sesión en OpenDash Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con OpenDash.
:::
...
OpenDash Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

OpenDash Zen funciona como cualquier otro proveedor en OpenDash.

1. Inicias sesión en **<a href={console}>OpenDash Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas OpenDash Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de OpenDash
usa el formato `opendash/<model-id>`. Por ejemplo, para GPT 5.3 Codex, usarías
`opendash/gpt-5.3-codex` en tu configuración.
...
- MiniMax M2.5 Free está disponible en OpenDash por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en OpenDash por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en OpenDash por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con OpenDash.
