---
title: Zen
description: Kuratierte Modellliste direkt von OpenDash.
---
...
OpenDash Zen ist eine Liste von getesteten und verifizierten Modellen, die vom OpenDash-Team bereitgestellt wird.

:::note
OpenDash Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenDash. Du meldest dich bei OpenDash Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um OpenDash zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit OpenDash funktionieren.
:::
...
OpenDash Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

OpenDash Zen funktioniert wie jeder andere Provider in OpenDash.

1. Du meldest dich bei **<a href={console}>OpenDash Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst OpenDash Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenDash-Konfiguration verwendet das Format `opendash/<model-id>`. Für GPT 5.3 Codex würdest du zum Beispiel `opendash/gpt-5.3-codex` in deiner Konfiguration verwenden.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf OpenDash verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf OpenDash verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf OpenDash verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben OpenDash Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit OpenDash auch jeden anderen Provider zu verwenden.
