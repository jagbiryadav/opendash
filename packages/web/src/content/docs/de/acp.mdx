...
description: Verwenden Sie OpenDash in jedem ACP-kompatiblen Editor.
---

OpenDash unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um OpenDash über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `opendash acp`.

Der Befehl startet OpenDash als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „OpenDash“ in der AI Chat Agent Selector.
...
Um OpenDash als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass OpenDash als ACP-Agent für den Chat verwendet wird.
...
OpenDash funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer OpenDash-Konfiguration konfiguriert sind
