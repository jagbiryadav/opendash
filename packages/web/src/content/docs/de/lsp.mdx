---
title: LSP Server
description: OpenDash lässt sich in Ihren LSP-Server integrieren.
---

OpenDash lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

OpenDash verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn OpenDash eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer OpenDash-Konfiguration anpassen.
