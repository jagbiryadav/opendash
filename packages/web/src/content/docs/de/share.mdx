---
title: Teilen
description: Teile OpenDash-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenDash-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenDash Folgendes:
...
OpenDash hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenDash den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`opendash.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du opendash in deiner Organisation einsetzt.
