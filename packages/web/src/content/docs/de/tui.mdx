---
title: TUI
description: Arbeite mit OpenDash in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet OpenDash die TUI im aktuellen Verzeichnis.
...
In der OpenDash-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu OpenDash hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet OpenDash. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `opendash.json`, welche das Server-/Runtime-Verhalten konfiguriert.
