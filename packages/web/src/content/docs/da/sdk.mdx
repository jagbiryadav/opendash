...
Brug den til at bygge integrasjoner og kontrollere opendash programmatisk.
...
Opret en forekomst av opendash:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `opendash.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av opendash, kan du oprete en klientforekomst for at koble til den:
