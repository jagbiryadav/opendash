---
title: LSP-servere
description: OpenDash integreres med dine LSP-servere.
---

OpenDash integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

OpenDash leveres med flere indbyggede LSP-servere til populære sprog:
...
Når opendash åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din opendash-konfiguration.
