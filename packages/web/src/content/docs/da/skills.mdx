...
Agentferdigheter lar OpenDash oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OpenDash opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenDash viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `opendash.json`:
