...
Opret `.opendash/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem OpenDash-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din OpenDash [config](/docs/config):
...
- Globalt: `~/.config/opendash/commands/`
- Pr. projekt: `.opendash/commands/`
...
opendash indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
