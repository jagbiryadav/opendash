---
title: TUI
description: Brug af OpenDash-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenDash giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OpenDash starter TUI for den nuværende mappe.
...
Når du bruger OpenDash TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OpenDash. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OpenDash. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `opendash.json`, som konfigurerer server-/kørselstidsadfærd.
