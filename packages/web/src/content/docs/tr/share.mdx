---
title: Paylasim
description: opendash konusmalarini genel baglantilarla paylasin.
---

opendash'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda opendash:
...
opendash, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak opendash manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `opendash.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda opendash kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
