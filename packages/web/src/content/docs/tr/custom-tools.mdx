---
title: Özel Araçlar
description: LLM'un opendash'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. opendash'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.opendash/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/opendash/tools/` içine yerleştirerek.
