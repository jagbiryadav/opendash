...
`.opendash/commands/test.md` oluştur:
...
opendash işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

opendash [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/opendash/commands/`
- Proje başına: `.opendash/commands/`
...
opendash, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
