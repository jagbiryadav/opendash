...
สร้าง `.opendash/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenDash:
...
- ระดับผู้ใช้ (Global): `~/.config/opendash/commands/`
- ระดับโปรเจ็กต์: `.opendash/commands/`
...
OpenDash มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
