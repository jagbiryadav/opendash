---
title: LSP Servers
description: OpenDash integrates with your LSP servers.
---

OpenDash integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

OpenDash comes with several built-in LSP servers for popular languages:
...
You can customize LSP servers through the `lsp` section in your opendash config.
