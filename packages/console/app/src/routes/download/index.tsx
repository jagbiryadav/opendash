...
import desktopAppIcon from "../../asset/lander/opendash-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://opendashai.netlify.app/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>opendashai.netlify.app/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g opendash-ai")}>
                <code>
                  npm i -g <strong>opendash-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g opendash-ai")}>
                <code>
                  bun add -g <strong>opendash-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install opendash/tap/opendash")}>
                <code>
                  brew install <strong>opendash/tap/opendash</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S opendash")}>
                <code>
                  paru -S <strong>opendash</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask opendash-desktop")}>
                <code>
                  brew install --cask <strong>opendash-desktop</strong>
                </code>
                <CopyStatus />
              </button>
