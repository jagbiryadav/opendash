...
import { and, Database, eq, isNull, lt, or, sql } from "@opendash-ai/console-core/drizzle/index.js"
import { KeyTable } from "@opendash-ai/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@opendash-ai/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@opendash-ai/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@opendash-ai/console-core/util/date.js"
import { Identifier } from "@opendash-ai/console-core/identifier.js"
import { Billing } from "@opendash-ai/console-core/billing.js"
import { Actor } from "@opendash-ai/console-core/actor.js"
import { WorkspaceTable } from "@opendash-ai/console-core/schema/workspace.sql.js"
import { ZenData } from "@opendash-ai/console-core/model.js"
import { Subscription } from "@opendash-ai/console-core/subscription.js"
import { BlackData } from "@opendash-ai/console-core/black.js"
import { UserTable } from "@opendash-ai/console-core/schema/user.sql.js"
import { ModelTable } from "@opendash-ai/console-core/schema/model.sql.js"
import { ProviderTable } from "@opendash-ai/console-core/schema/provider.sql.js"
...
import { LiteData } from "@opendash-ai/console-core/lite.js"
import { Resource } from "@opendash-ai/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-opendash-session") ?? ""
    const requestId = input.request.headers.get("x-opendash-request") ?? ""
    const projectId = input.request.headers.get("x-opendash-project") ?? ""
    const ocClient = input.request.headers.get("x-opendash-client") ?? ""
    logger.metric({
      is_stream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-opendash-request")
          headers.delete("x-opendash-session")
          headers.delete("x-opendash-project")
          headers.delete("x-opendash-client")
          return headers
        })(),
        body: reqBody,
      })
    ...
    if (modelData.trialEnded)
      throw new ModelError(
        `${t("zen.api.error.trialEnded", {
          ...
          link: "https://opendashai.netlify.app/go",
        })}`,
      )
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://opendashai.netlify.app/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://opendashai.netlify.app/workspace/${authInfo.workspaceID}/members`
