...
import compareVideo from "../../asset/lander/opendash-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/opendash-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="opendash:auth" content={loggedin() ? "true" : "false"} />
