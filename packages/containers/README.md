...
```
REGISTRY=ghcr.io/opendash TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/opendash TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/opendash/build/bun-node:24.04
```
