...
import { base64Encode } from "@opendash-ai/shared/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@opendash-ai/ui/resize-handle"
import { Button } from "@opendash-ai/ui/button"
import { IconButton } from "@opendash-ai/ui/icon-button"
import { Tooltip } from "@opendash-ai/ui/tooltip"
...
import { Session, type Message } from "@opendash-ai/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@opendash-ai/ui/toast"
...
import { retry } from "@opendash-ai/shared/util/retry"
...
import { useTheme, type ColorScheme } from "@opendash-ai/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://opendashai.netlify.app/desktop-feedback")}
      renderPanel={() =>
