...
beforeAll(async () => {
  ...
  mock.module("@opendash-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@opendash-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@opendash-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@opendash-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
