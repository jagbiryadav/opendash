export const dict = {
  ...
  "dialog.provider.opendash.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.opendash.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.opendashGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje OpenDash",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u OpenDash-u.",
  ...
  "provider.connect.opendashZen.line1":
    "OpenDash Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.opendashZen.visit.prefix": "Posjeti ",
  "provider.connect.opendashZen.visit.link": "opendashai.netlify.app/zen",
  "provider.connect.opendashZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u OpenDash-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u OpenDash-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u opendash.json",
  ...
  "dialog.server.description": "Promijeni na koji se OpenDash server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija OpenDash-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku OpenDash timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (opendash.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: OpenDash još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "OpenDash uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni OpenDash server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u OpenDash-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako OpenDash izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li OpenDash prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu OpenDash-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se OpenDash pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju OpenDash-a.",
