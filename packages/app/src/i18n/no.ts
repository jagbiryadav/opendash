...
export const dict = {
  ...
  "dialog.provider.opendash.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.opendash.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.opendashGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av OpenDash",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i OpenDash.",
  ...
  "provider.connect.opendashZen.line1":
    "OpenDash Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.opendashZen.visit.prefix": "Besøk ",
  "provider.connect.opendashZen.visit.link": "opendashai.netlify.app/zen",
  "provider.connect.opendashZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i OpenDash.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i OpenDash.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i opendash.json",
  ...
  "dialog.server.description": "Bytt hvilken OpenDash-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av OpenDash ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til OpenDash-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (opendash.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at OpenDash ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "OpenDash inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør OpenDash-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for OpenDash",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan OpenDash ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om OpenDash skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan OpenDash er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når OpenDash starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av OpenDash.",
