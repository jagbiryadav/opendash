export const dict = {
  ...
  "dialog.provider.opendash.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.opendash.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.opendashGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez OpenDash",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w OpenDash.",
  ...
  "provider.connect.opendashZen.line1":
    "OpenDash Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.opendashZen.visit.prefix": "Odwiedź ",
  "provider.connect.opendashZen.visit.link": "opendashai.netlify.app/zen",
  "provider.connect.opendashZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w OpenDash.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w OpenDash.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w opendash.json",
  ...
  "dialog.server.description": "Przełącz serwer OpenDash, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja OpenDash ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu OpenDash",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (opendash.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "OpenDash zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla OpenDash",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd OpenDash na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy OpenDash ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw OpenDash.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania OpenDash",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji OpenDash.",
