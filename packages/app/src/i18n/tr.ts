...
export const dict = {
  ...
  "dialog.provider.opendash.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.opendash.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.opendashGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "OpenDash tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve OpenDash'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opendashZen.line1":
    "OpenDash Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.opendashZen.visit.prefix": "",
  "provider.connect.opendashZen.visit.link": "opendashai.netlify.app/zen",
  "provider.connect.opendashZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve OpenDash'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak OpenDash'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler opendash.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi OpenDash sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "OpenDash'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı OpenDash ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (opendash.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: OpenDash henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "OpenDash ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "OpenDash Masaüstü",
  ...
  "settings.desktop.wsl.description": "OpenDash sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "OpenDash'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "OpenDash'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "OpenDash'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "OpenDash'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "OpenDash başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "OpenDash'un en son sürümünü kullanıyorsunuz.",
