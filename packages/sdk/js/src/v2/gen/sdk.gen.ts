...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OpenDash configuration settings and preferences.
   */
   ...
   *
   * Update global OpenDash configuration settings and preferences.
   */
...
export class Import extends HeyApiClient {
   ...
   *
   * Import sessions from external AI tools (Claude Code, Codex, opendash) into mimocode. Idempotent; pass force to re-sync. Per-source failures are not thrown as HTTP errors — they are collected into the corresponding stats.errors[] while other sources continue.
   */
  public run<ThrowOnError extends boolean = false>(
    parameters?: {
      sources?: Array<"cc" | "codex" | "opendash">
      force?: boolean
    },
    options?: Options<never, ThrowOnError>,
  ) {
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OpenDash server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OpenDash system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OpenDash instances, releasing all resources.
   */
   ...
   * Upgrade opendash
   *
   * Upgrade opendash to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the OpenDash system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the OpenDash system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local OpenDash state.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with OpenDash.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that OpenDash is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by OpenDash.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current OpenDash configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update OpenDash configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all OpenDash sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new OpenDash session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific OpenDash session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current OpenDash instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the OpenDash instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the OpenDash system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
