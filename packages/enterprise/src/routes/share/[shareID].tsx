import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@opendash-ai/sdk/v2"
import { SessionTurn } from "@opendash-ai/ui/session-turn"
import { SessionReview } from "@opendash-ai/ui/session-review"
import { DataProvider } from "@opendash-ai/ui/context"
import { FileComponentProvider } from "@opendash-ai/ui/context/file"
import { WorkerPoolProvider } from "@opendash-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@opendash-ai/ui/logo"
import { IconButton } from "@opendash-ai/ui/icon-button"
import { ProviderIcon } from "@opendash-ai/ui/provider-icon"
import { iife } from "@opendash-ai/shared/util/iife"
import { Binary } from "@opendash-ai/shared/util/binary"
import { NamedError } from "@opendash-ai/shared/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@opendash-ai/ui/tabs"
import { MessageNav } from "@opendash-ai/ui/message-nav"
import { FileSSR } from "@opendash-ai/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@opendash-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/opendash-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | OpenDash</Title>
              </Show>
              <Meta name="description" content="opendash - The AI coding agent built for the terminal." />
                      ...
                      return (
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            <div class="">
                              <a href="https://opendashai.netlify.app">
                                <Mark />
                              </a>
                            </div>
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/opendash/opendash"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
                              <IconButton
                                as={"a"}
                                href="https://opendashai.netlify.app/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
